...
import ManageAvailability from "./pages/agenda/ManageAvailability";
          ...
          <BrowserRouter>
            <Routes>
              ...
              >
                ...
                <Route path="agendamentos/disponibilidade" element={<ManageAvailability />} />
                ...
                <Route path="marketing/comunicacao" element={<Communications />} />
