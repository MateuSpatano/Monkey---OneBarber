      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground font-medium text-sm sm:text-base">
            Gerencie as funções e permissões de acesso ao sistema
          </p>
        </div>
        {canCreate('roles') && (
          <Button asChild className="premium-button-solid h-11 sm:h-12 px-6 shadow-xl">
                      ...
                      <TableCell>
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl hover:bg-zinc-100 transition-all text-muted-foreground hover:text-foreground">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent className="rounded-[32px] border-none shadow-2xl p-8">
          ...
          <AlertDialogFooter className="gap-3 pt-6">
            <AlertDialogCancel disabled={deleting} className="premium-button-ghost border-none h-11 px-6 m-0">Cancelar</AlertDialogCancel>
            <AlertDialogAction
              onClick={handleDelete}
              disabled={deleting}
              className="premium-button-solid bg-destructive hover:bg-destructive/90 text-white border-none h-11 px-8 shadow-lg m-0"
            >
